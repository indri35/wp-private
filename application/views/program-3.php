...
<head>
  ...
  <!-- Basic -->
  <title>ESC | Program Intensif UN/SBMPTN</title>
  ...
  <div id="container">
    ...
    <div class="page-banner" style="padding:40px 0; background: url(images/slide-02-bg.jpg) center #f9f9f9;">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h2>Program Intensif UN/SBMPTN</h2>
          </div>
          <div class="col-md-6">
            <ul class="breadcrumbs">
              <li><a href="<?php echo base_url()?>assets/#">Home</a></li>
              <li>Program Intensif UN/SBMPTN</li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <center><table border="1" cellpadding="0" cellspacing="0">
                    ...
                    <p>Fasilitas Prima Program Intensif UN/SBMPTN :<br/>
                        1. Bank soal persiapan detik-detik UN/SBMPTN<br/>
                        2. Modul materi pelajaran dilengkapi latihan soal (Matematika, Bahasa Indonesia, IPA, IPS, B. Inggris)<br/>
                        3. Try Out rutin secara berkala<br/>
                        4. Laporan perkembangan akademik siswa secara berkala<br/>
                        5. Nilai evaluasi secara berkala<br/>
                    </p>
            </div>
