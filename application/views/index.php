					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation"><a href="<?php echo base_url()?>Welcome/index" class="active">Home</a></li>
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h2 class="animation animated-item-1">Welcome <span>ESC</span></h2>
                                    <p class="animation animated-item-2">Education Solution Center (ESC) hadir di tengah-tengah masyarakat Bandung, Cimahi, Jatinangor, dan sekitarnya...</p>
