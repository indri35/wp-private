...
<head>
  ...
  <!-- Basic -->
  <title>ESC | Program Eksklusif (1 semester & 2 semester)</title>
  ...
  <!--[if IE 8]><script src="<?php echo base_url()?>assets/http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><![endif]-->
  <!--[if lt IE 9]><script src="<?php echo base_url()?>assets/http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><![endif]-->
...
<body>
  ...
  <div id="container">
      ...
      <div class="navbar navbar-default navbar-top">
        <div class="container">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li>
                <a href="<?php echo base_url()?>Welcome/data">Data Siswa</a>
              </li>
              <li>
              ...
              <li>
                ...
                <ul class="dropdown">
                  <li><a href="<?php echo base_url()?>Welcome/program">Reguler</a></li>
                  <li><a href="<?php echo base_url()?>Welcome/program2">Unggulan</a></li>
                  <li><a href="<?php echo base_url()?>Welcome/program3">Intensif UN/SBMPTN</a></li>
                  <li><a href="<?php echo base_url()?>Welcome/program4">Eksklusif (1 semester & 2 semester)</a></li>
                </ul>
              </li>
              <li>
        ...
        <ul class="wpb-mobile-menu">
          <li>
              ...
              <li>
                <a class="active" href="<?php echo base_url()?>Welcome/program">Program</a>
                <ul class="dropdown">
                  <li><a href="<?php echo base_url()?>Welcome/program">Reguler</a></li>
                  <li><a href="<?php echo base_url()?>Welcome/program2">Unggulan</a></li>
                  <li><a href="<?php echo base_url()?>Welcome/program3">Intensif UN/SBMPTN</a></li>
    ...
    <div class="page-banner" style="padding:40px 0; background: url(images/slide-02-bg.jpg) center #f9f9f9;">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h2>Program Eksklusif (1 semester & 2 semester)</h2>
          </div>
          <div class="col-md-6">
            <ul class="breadcrumbs">
              <li><a href="<?php echo base_url()?>assets/#">Home</a></li>
              <li>Program Eksklusif (1 semester & 2 semester)</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="page-content">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <!-- Classic Heading -->
              <h4 class="classic-title"><span>Program Eksklusif (1 semester & 2 semester)</span></h4>
              ...
              <center><table border="1" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                ...
                                <strong>Program Eksklusif (1 semester)</strong>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <center><table border="1" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                ...
                                <td align="center" colspan="3" style="width:450px">
                                <strong>Program Eksklusif (2 semester)</strong>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" colspan="3" style="width:450px">
                            ...
                            <tr>
                                ...
                                <strong>Paket Gold</strong><br/>
                                <strong>(72x pertemuan)</strong>
                                </td>
                                <td align="center" style="width:120px">
                                <strong>Paket Platinum</strong><br/>
                                <strong>(96x pertemuan)</strong>
                                </td>
                            </tr>
                            <tr>
                                <td>
                    ...
                    <p>Bimbingan Belajar Privat ESC hadir menemani siswa belajar dengan metode belajar yang aktif, kreatif, efektif dan menyenangkan. Metode belajar yang memudahkan siswa dalam memahami pelajaran secara intensif dengan dibimbing tutor terbaik. Suasana belajar dibuat menyenangkan tanpa mengurangi konsentrasi siswa untuk fokus belajar. Tutor akan membantu siswa dalam menghadapi soal-soal mata pelajaran dengan cepat, tepat dan mudah. Siswa bebas menentukan jumlah dan jadwal pertemuan setiap minggunya sesuai keinginan dan kebutuhan.</p>

                    <p>&nbsp;</p>

                    <p>Harga diatas sudah termasuk fasilitas dibawah ini:<br/>
                        1. Bebas biaya transport tutor (baik jauh maupun dekat).<br/>
                        2. Gratis konsultasi akademik.<br/>
                        3. Sistem pembayaran pascabayar/prabayar.<br/>
                        4. Jadwal belajar fleksibel sesuai kebutuhan siswa.<br/>
                        5. Fasilitas bimbingan belajar 90 menit.<br/>
                        6. Request penggantian guru apabila siswa kurang cocok.<br/>
                        7. Materi pembelajaran setiap pertemuan akan dicatat dalam lembar absensi oleh tutor les yang bersangkutan.<br/>
                        </p>
                       
                        <p>Fasilitas Prima Program Eksklusif :<br/>
                        1. Bank soal pelajaran (Matematika, Bahasa Indonesia, IPA, IPS, B. Inggris)<br/>
                        2. Modul materi pelajaran dilengkapi latihan soal (Matematika, Bahasa Indonesia, IPA, IPS, B. Inggris)<br/>
                        3. Laporan perkembangan akademik siswa secara berkala<br/>
                        4. Nilai evaluasi berkala<br/>
                        5. Gratis Test bakat dan minat<br/>
                        6. Gratis Tes Potensi akademik (untuk mengetahui potensi kemampuan dasar siswa)<br/>
                        7. Gratis Tes visual, auditori dan kinestetik (untuk mengetahui pola pengajaran siswa)<br/>
                        8. Gratis Tes pola berpikir siswa (untuk mengetahui karakteristik belajar siswa)<br/>
                        9. Try Out rutin berkala dan Try Out gabungan tahunan<br/>
                        10. Tersedia program bilingual<br/>
                        11. Gratis konsultasi akademik dan non akademik<br/>
                        12. Gratis seminar &quot;Trik Jitu Menghadapi UN dan SBMPTN<br/>
                        13. Seminar kit<br/>
                        14. 1% uang yang dibayarkan akan didonasikan ke dalam program beasiswa bagi anak kurang mampu<br/>
                    </p>
            </div>
  ...
  <!-- Go To Top Link -->
  <a href="<?php echo base_url()?>assets/#" class="back-to-top"><i class="fa fa-angle-up"></i></a>
  ...
  <div class="switcher-box">
    ...
    <ul class="bg-list">
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg1"></a>
      </li>
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg2"></a>
      </li>
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg3"></a>
      </li>
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg4"></a>
      </li>
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg5"></a>
      </li>
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg6"></a>
      </li>
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg7"></a>
      </li>
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg8"></a>
      </li>
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg9"></a>
      </li>
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg10"></a>
      </li>
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg11"></a>
      </li>
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg12"></a>
      </li>
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg13"></a>
      </li>
      <li>
        <a href="<?php echo base_url()?>assets/#" class="bg14"></a>
      </li>
    </ul>
  </div>
