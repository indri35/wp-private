...
<head>
  ...
  <!-- Responsive CSS Styles  -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/css/dataTables.bootstrap.min.css" media="screen">
  ...
  <script type="text/javascript"> src="<?php echo base_url()?>assets/http://maps.googleapis.com/maps/api/js?sensor=false"</script>
      ...
      <div class="container">
              ...
              <div class="col-sm-12">
                  <table class="table">
                      ...
                      <? foreach ($siswa as $row) : ?>
                          <tr>
                          <td><? echo $row->id_student; ?></td>
                          <td><? echo $row->nama; ?></td>
                          <td><? echo $row->ttl; ?></td>
                          <td><? echo $row->jenis_kelamin; ?></td>
                          <td><? echo $row->agama; ?></td>
                          <td><? echo $row->asal_sekolah; ?></td>
                          <td><? echo $row->kelas; ?></td>
                          <td><? echo $row->no_tlp; ?></td>
                          <td><? echo $row->email; ?></td>
                          <td><? echo $row->alamat; ?></td>
                          <td><? echo $row->jadwal_les; ?></td>
                          </tr>
                          <? endforeach; ?>                                            
                      </tbody>
                  </table>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <!-- Info - Icons List -->
            <ul class="icons-list">
              <li><i class="fa fa-globe">  </i> <strong>Address:</strong> Jl. Rancakendal Luhur No 49, Bandung</li>
              <li><i class="fa fa-envelope-o"></i> <strong>Email:</strong> educationsolutionscenter@gmail.com</li>
              <li><i class="fa fa-mobile"></i> <strong>Phone:</strong> +62 858 9412 8283</li>
            </ul>
            <div class="hr1" style="margin-bottom:200px;"></div>
          </div>
        </div>
      </div>
    </div>
